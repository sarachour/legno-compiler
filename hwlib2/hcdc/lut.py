...
lut.codes.add(BlockCode('source', BlockCodeType.CONNECTION, \
                        values=enums.LUTSourceType))
lut.codes['source'].impl.source('adc',['@','@',0,0],'x', \
                           enums.LUTSourceType.ADC0)
lut.codes['source'].impl.source('adc',['@','@',2,0],'x', \
                           enums.LUTSourceType.ADC1)
lut.codes['source'].impl.set_default(enums.LUTSourceType.EXTERN)
